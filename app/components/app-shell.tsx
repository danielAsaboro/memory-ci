      ...
      <aside className={`sidebar ${open ? "sidebar-open" : ""}`} aria-label="Primary navigation">
        ...
        <nav className="nav-list">
          {navigation.map((item) => {
            ...
            return <Link key={item.href} href={item.href} className={active ? "nav-link active" : "nav-link"} aria-current={active ? "page" : undefined} onClick={() => setOpen(false)}>
        ...
        <div className="sidebar-bottom">
          ...
          <div className="environment-card"><span className="live-dot" />Sandbox demo <small>Cloud proof pending</small></div>
        </div>
      </aside>
